...
router.post('/register', (req, res) => {
  try {
    ...
    // ユーザー情報更新
    db.prepare(`UPDATE users SET name=?, address=?, phone=?, password_hash=?, password_salt=?, status='pending_review' WHERE id=?`)
    ...
    db.prepare(`INSERT INTO registration_requests (user_id, name, address, phone) VALUES (?, ?, ?, ?)`)
